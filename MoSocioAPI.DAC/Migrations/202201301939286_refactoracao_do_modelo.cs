namespace MoSocioAPI.DAC.Migrations
{
    ...
    public partial class refactoracao_do_modelo : DbMigration
    {
        public override void Up()
        {
            ...
            CreateIndex("dbo.Institutions", "Telefone1", unique: true);
            CreateIndex("dbo.Institutions", "Email", unique: true);
            CreateIndex("dbo.Institutions", "ProvinceId");
            CreateIndex("dbo.Partners", "Telefone1", unique: true);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Partners", new[] { "Telefone1" });
            DropIndex("dbo.Institutions", new[] { "ProvinceId" });
            DropIndex("dbo.Institutions", new[] { "Email" });
            DropIndex("dbo.Institutions", new[] { "Telefone1" });
